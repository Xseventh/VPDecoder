...
static void PrintProfile(Vp9PerfCounterSnapshot[] snapshots, double averageMs)
{
    ...
    Console.WriteLine(
        ...
        FormatNestedStage("intraEdgePrep", AverageMs(snapshots, static snapshot => snapshot.IntraEdgePreparationTicks), AverageMs(snapshots, static snapshot => snapshot.InterIntraReconstructionTicks), parentName: "IntraRecon") + " " +
        FormatNestedStage("intraPredict", AverageMs(snapshots, static snapshot => snapshot.IntraPredictionTicks), AverageMs(snapshots, static snapshot => snapshot.InterIntraReconstructionTicks), parentName: "IntraRecon") + " " +
        FormatNestedStage("intraResidualAdd", AverageMs(snapshots, static snapshot => snapshot.IntraResidualAddTicks), AverageMs(snapshots, static snapshot => snapshot.InterIntraReconstructionTicks), parentName: "IntraRecon") + " " +
        FormatNestedStage("intraDcOnlyAdd", AverageMs(snapshots, static snapshot => snapshot.IntraDcOnlyAddTicks), AverageMs(snapshots, static snapshot => snapshot.IntraResidualAddTicks), parentName: "IntraResidual") + " " +
        FormatNestedStage("intraInverseTransform", AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTicks), AverageMs(snapshots, static snapshot => snapshot.IntraResidualAddTicks), parentName: "IntraResidual") + " " +
        FormatNestedStage("intraInvTx4", AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformSizeTicks[(int)Vp9TransformSize.Tx4X4]), AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTicks), parentName: "IntraInverse") + " " +
        FormatNestedStage("intraInvTx8", AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformSizeTicks[(int)Vp9TransformSize.Tx8X8]), AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTicks), parentName: "IntraInverse") + " " +
        FormatNestedStage("intraInvTx16", AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformSizeTicks[(int)Vp9TransformSize.Tx16X16]), AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTicks), parentName: "IntraInverse") + " " +
        FormatNestedStage("intraInvTx32", AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformSizeTicks[(int)Vp9TransformSize.Tx32X32]), AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTicks), parentName: "IntraInverse") + " " +
        FormatNestedStage("intraInvDctDct", AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTypeTicks[(int)Vp9TransformType.DctDct]), AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTicks), parentName: "IntraInverse") + " " +
        FormatNestedStage("intraInvAdstDct", AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTypeTicks[(int)Vp9TransformType.AdstDct]), AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTicks), parentName: "IntraInverse") + " " +
        FormatNestedStage("intraInvDctAdst", AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTypeTicks[(int)Vp9TransformType.DctAdst]), AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTicks), parentName: "IntraInverse") + " " +
        FormatNestedStage("intraInvAdstAdst", AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTypeTicks[(int)Vp9TransformType.AdstAdst]), AverageMs(snapshots, static snapshot => snapshot.IntraInverseTransformTicks), parentName: "IntraInverse") + " " +
        FormatCounter("intraInvTx4Calls", Average(snapshots, static snapshot => snapshot.IntraInverseTransformSizeCalls[(int)Vp9TransformSize.Tx4X4])) + " " +
        FormatCounter("intraInvTx8Calls", Average(snapshots, static snapshot => snapshot.IntraInverseTransformSizeCalls[(int)Vp9TransformSize.Tx8X8])) + " " +
        FormatCounter("intraInvTx16Calls", Average(snapshots, static snapshot => snapshot.IntraInverseTransformSizeCalls[(int)Vp9TransformSize.Tx16X16])) + " " +
        FormatCounter("intraInvTx32Calls", Average(snapshots, static snapshot => snapshot.IntraInverseTransformSizeCalls[(int)Vp9TransformSize.Tx32X32])) + " " +
        FormatCounter("intraInvDctDctCalls", Average(snapshots, static snapshot => snapshot.IntraInverseTransformTypeCalls[(int)Vp9TransformType.DctDct])) + " " +
        FormatCounter("intraInvAdstDctCalls", Average(snapshots, static snapshot => snapshot.IntraInverseTransformTypeCalls[(int)Vp9TransformType.AdstDct])) + " " +
        FormatCounter("intraInvDctAdstCalls", Average(snapshots, static snapshot => snapshot.IntraInverseTransformTypeCalls[(int)Vp9TransformType.DctAdst])) + " " +
        FormatCounter("intraInvAdstAdstCalls", Average(snapshots, static snapshot => snapshot.IntraInverseTransformTypeCalls[(int)Vp9TransformType.AdstAdst])) + " " +
